...
OUT_FILE=$OUT_DIR/sheet2mangojson-debian13
...
podman run --rm --volume $ROOT_DIR/:/src --volume $TMP_DIR:/tmp pyinstaller-builder-debian-13:latest /bin/bash /tmp/build.sh
mkdir -p $OUT_DIR
