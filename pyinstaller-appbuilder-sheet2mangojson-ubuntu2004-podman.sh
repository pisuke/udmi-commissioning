...
OUT_FILE=$OUT_DIR/sheet2mangojson-ubuntu2004
...
podman run --rm --volume $ROOT_DIR/:/src --volume $TMP_DIR:/tmp pyinstaller-builder-ubuntu-2004:latest /bin/bash /tmp/build.sh
mkdir -p $OUT_DIR
