...
OUT_FILE=$OUT_DIR/bacnet-scan-ubuntu2004
...
podman run --rm --network host --volume $ROOT_DIR/:/src --volume $TMP_DIR:/tmp pyinstaller-builder-ubuntu-2004:latest /bin/bash /tmp/build.sh
mkdir -p $OUT_DIR
